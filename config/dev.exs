...
config :ordo, OrdoWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RtEmcgr5FqkZETh1wdRQPw+vOivBbRBH1bZX5El/cpy/Zloy20QR47I1sjseeFK4",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:ordo, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:ordo, ~w(--watch)]}
  ]
...
config :ordo, OrdoWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/ordo_web/router\.ex$",
      ~r"lib/ordo_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
