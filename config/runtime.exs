...
#
#     PHX_SERVER=true bin/ordo start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :ordo, OrdoWeb.Endpoint, server: true
end

config :ordo, OrdoWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
