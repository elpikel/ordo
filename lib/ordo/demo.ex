  ...
  def policy_facts do
    [
      ...
      %{
        ...
        label: "Warunki zwrotu",
        value: "produkt nieotwarty, oryginalne opakowanie, dowód zakupu + nr konta",
        category: "RETURN"
      },
      %{
        key: "refund_method",
        label: "Forma zwrotu środków",
        value: "ta sama, co przy zamówieniu, po otrzymaniu przesyłki",
        category: "RETURN_STATUS"
      },
      %{
        key: "complaint_resolution_days",
        label: "Rozpatrzenie reklamacji",
        value: "14",
        unit: "dni",
        category: "COMPLAINT"
      },
      %{
        key: "complaint_requirements",
        label: "Do reklamacji potrzebne",
        value: "nr zamówienia, nr partii, zdjęcia",
        category: "COMPLAINT"
      },
      ...
      %{
        key: "free_shipping_club",
        label: "Darmowa dostawa (klub) od",
        value: "99",
        unit: "zł",
  ...
  defp build_orders do
    [
      order(
        ...
        "620441882",
        @dispatched_history,
        [%{"name" => "Granola Belgijska Czekolada 450g", "qty" => 2}]
      ),
      order(
        "ZAM-50102",
        "2026-08-13",
        ...
        "JD0002210455",
        @delivered_history,
        [%{"name" => "Mix Keto Matcha 600g", "qty" => 1}]
      ),
      order("ZAM-50103", "2026-08-18", "W realizacji", "processing", "Katarzyna Nowak", "k.nowak@onet.pl", nil, nil, [], [
        %{"name" => "Musli Proteinowe 400g", "qty" => 3}
      ]),
      order(
        "ZAM-50104",
        "2026-08-12",
        ...
        "OP778812345",
        @dispatched_history,
        [%{"name" => "Owsianka Vegan Kakao 300g", "qty" => 4}]
      ),
      order("ZAM-50105", "2026-08-19", "Nowe", "new", "Magdalena Lewandowska", "magda.lew@interia.pl", nil, nil, [], [
        %{"name" => "Granola Dubai Style 450g", "qty" => 1}
      ]),
      order(
        "ZAM-50106",
        "2026-08-11",
        ...
        "delivered",
        "Tomasz Kaczmarek",
        "t.kaczmarek@gmail.com",
        "InPost",
        "620559001",
        @delivered_history,
        [%{"name" => "Masło orzechowe 500g", "qty" => 2}]
      ),
      order(
        "ZAM-50107",
        "2026-08-17",
        ...
        "620573114",
        @dispatched_history,
        [%{"name" => "Musli bez cukru Owoce Leśne 750g", "qty" => 1}]
      ),
      order("ZAM-50108", "2026-08-16", "Spakowane", "processing", "Krzysztof Mazur", "kmazur@op.pl", nil, nil, [], [
        %{"name" => "Granola Proteinowa Wanilia 450g", "qty" => 2}
      ]),
      order(
        "ZAM-50109",
        "2026-08-10",
        ...
        "JD0002211987",
        @delivered_history,
        [%{"name" => "Owsianka PreWorkout 400g", "qty" => 3}]
      ),
      order(
        "ZAM-50110",
        "2026-08-15",
        ...
        "dispatched",
        "Michał Grabowski",
        "m.grabowski@gmail.com",
        "Orlen Paczka",
        "OP778890012",
        @dispatched_history,
        [%{"name" => "Mix Keto Kokos 600g", "qty" => 1}]
      ),
      order(
        "ZAM-50111",
        "2026-08-09",
        ...
        "620601447",
        @delivered_history,
        [%{"name" => "Granola Dessert Sernikowa 400g", "qty" => 2}]
      ),
      order(
        "ZAM-50112",
        "2026-08-18",
        ...
        "processing",
        "Robert Dąbrowski",
        "r.dabrowski@gmail.com",
        nil,
        nil,
        [],
        [%{"name" => "Musli dla dzieci 500g", "qty" => 5}]
      ),
      order(
        "ZAM-50113",
        "2026-08-14",
        ...
        "JD0002214003",
        @dispatched_history,
        [%{"name" => "Granola Belgijska Czekolada 450g", "qty" => 1}]
      ),
      order(
        "ZAM-50114",
        "2026-08-08",
        ...
        "delivered",
        "Paweł Król",
        "pawel.krol@gmail.com",
        "InPost",
        "620622889",
        @delivered_history,
        [%{"name" => "Musli Proteinowe 400g", "qty" => 2}]
      ),
      order(
        "ZAM-50115",
        "2026-08-16",
      ...
      order(
        ...
        "620655777",
        @dispatched_history,
        [%{"name" => "Owsianka Vegan Kakao 300g", "qty" => 2}]
      ),
      ...
      order(
        ...
        "dispatched",
        "James Miller",
        "james.miller@outlook.com",
        "DHL",
        "JD0009911223",
        @dispatched_history,
        [%{"name" => "Protein Granola Vanilla 450g", "qty" => 2}]
      )
    ]
  end
  ...
  defp build_emails do
    [
      ...
      mail(
        "Katarzyna Nowak",
        "k.nowak@onet.pl",
        "Kiedy wyślecie ZAM-50103?",
        "Dzień dobry, zamówienie ZAM-50103 wciąż jest w realizacji. Kiedy zostanie wysłane?"
      ),
      mail("Magdalena Lewandowska", "magda.lew@interia.pl", "gdzie paczka", "czemu tak długo, gdzie moja granola?"),
      mail(
        "Aleksandra Wieczorek",
        "ola.wieczorek@wp.pl",
        "Przesyłka",
      ...
      mail(
        "Tomasz Kaczmarek",
        "t.kaczmarek@gmail.com",
        "Reklamacja - uszkodzone opakowanie",
      ...
      mail("Grzegorz Bąk", "g.bak@wp.pl", "Godziny pracy sklepu", "W jakich godzinach mogę do Was zadzwonić?"),

      # (1) no matching order
      mail(
        "Łukasz Nowicki",
        "lukasz.nowicki88@gmail.com",
