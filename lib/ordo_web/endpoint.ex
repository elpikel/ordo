defmodule OrdoWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :ordo
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :ordo
  end
  ...
  plug Plug.Parsers,
    ...
    pass: ["*/*"],
    body_reader: {OrdoWeb.CacheBodyReader, :read_body, []},
