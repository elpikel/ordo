defmodule OrdoWeb.UserAuth do
  ...
  def disconnect_sessions(tokens) do
    Enum.each(tokens, fn %{token: token} ->
      OrdoWeb.Endpoint.broadcast(user_session_topic(token), "disconnect", %{})
    end)
  end
  ...
  the `current_scope`:
      ...
      defmodule OrdoWeb.PageLive do
        ...
        on_mount {OrdoWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{OrdoWeb.UserAuth, :require_authenticated}] do
  ...
  @doc "Returns the path to redirect to after log in — the tenant inbox."
  def signed_in_path(_conn), do: ~p"/inbox"
